import { WebMercatorTilingScheme, Rectangle, Ellipsoid, Cartesian2, GeographicTilingScheme, Credit, Event, ImageryLayerFeatureInfo } from 'terriajs-cesium';
import { TypedArray as TypedArray$1, Pool } from 'geotiff';
...
declare type ResampleDataOptions = {
    sourceWidth: number;
    sourceHeight: number;
    targetWidth: number;
    targetHeight: number;
...
declare class WorkerPool {
    ...
    resample(data: TypedArray$1, options: ResampleDataOptions): Promise<TypedArray$1>;
    destroy(): void;
}
...
declare class TIFFImageryProvider {
     ...
     */
    private _loadTile;
    requestImage(x: number, y: number, z: number): Promise<HTMLCanvasElement | OffscreenCanvas | ImageData | HTMLImageElement>;
