...
export default class TableStyleMap {
    ...
    get styleMap() {
        ...
        if ((this.traitValues.mapType === "bin" || !this.traitValues.mapType) &&
            ...
            const mapValueToStyle = (value) => {
                var _a, _b, _c, _d;
                if (typeof value !== "number") {
                    return this.traitValues.null;
                }
                const binStyles = (_a = this.traitValues.bin) !== null && _a !== void 0 ? _a : [];
                let i;
                for (i = 0; i < binStyles.length - 1 &&
                    value > ((_b = binStyles[i].maxValue) !== null && _b !== void 0 ? _b : Infinity); ++i) {
                    continue;
                }
                return {
                    ...this.traitValues.null,
                    ...((_d = (_c = this.traitValues.bin) === null || _c === void 0 ? void 0 : _c[i]) !== null && _d !== void 0 ? _d : {})
                };
            };
            return {
                type: "bin",
                mapRowIdToStyle: (rowId) => { var _a; return mapValueToStyle((_a = this.column) === null || _a === void 0 ? void 0 : _a.valuesForType[rowId]); },
                mapValueToStyle
            };
        }
            ...
            const mapValueToStyle = (value) => {
                const style = this.traitValues.enum.find((enumStyle) => enumStyle.value !== null && enumStyle.value === value);
                return { ...this.traitValues.null, ...(style !== null && style !== void 0 ? style : {}) };
            };
            return {
                type: "enum",
                mapRowIdToStyle: (rowId) => { var _a; return mapValueToStyle((_a = this.column) === null || _a === void 0 ? void 0 : _a.values[rowId]); },
                mapValueToStyle
            };
        }
