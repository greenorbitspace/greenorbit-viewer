...
class TableAutomaticStylesStratum extends LoadableStratum(TableTraits) {
    ...
    get styles() {
        ...
        const columnStyles = this.catalogItem.tableColumns.map((column, _i) => createStratumInstance(TableStyleTraits, {
            id: column.name,
    ...
    get showDisableTimeOption() {
        ...
        for (let i = 0; i < this.catalogItem.activeTableStyle.rowGroups.length; i++) {
            const [_rowGroupId, rowIds] = this.catalogItem.activeTableStyle.rowGroups[i];
