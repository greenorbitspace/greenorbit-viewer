...
class TableFeatureInfoStratum extends LoadableStratum(TableTraits) {
    ...
    get featureInfoTemplate() {
        ...
        template += (_b = (_a = this.catalogItem.tableColumns) === null || _a === void 0 ? void 0 : _a.filter((col) => col.name !== FEATURE_ID_PROP)) === null || _b === void 0 ? void 0 : _b.map((col) => `<tr><td style="vertical-align: middle"><b>${col.title}</b></td><td>{{${col.name}}}</td></tr>`).join("");
