    ...
    render() {
        ...
        return (_jsx(Swipeable, { onSwipedLeft: () => this.goToNextStory(), onSwipedRight: () => this.goToPrevStory(), children: _jsx(Box, { className: classNames(this.props.viewState.topElement === "StoryPanel"
          ...
          `, children: _jsxs(Box, { column: true, rounded: true, className: classNames(Styles.storyContainer, {
              ...
              border-radius: 6px;
              overflow: hidden;
            `, children: [_jsx(Box, { backgroundColor: this.props.theme.dark, css: { color: "white" }, paddedRatio: 3, column: true, children: _jsx(TitleBar, { title: story.title, isCollapsed: this.state.isCollapsed, collapseHandler: () => this.toggleCollapse(), closeHandler: () => this.exitStory() }) }), _jsx(Box, { css: {
