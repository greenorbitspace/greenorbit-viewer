...
let StoryBuilder = class StoryBuilder extends Component {
    ...
    renderIntro() {
        var _a;
        const { t } = this.props;
        return (_jsxs(Box, { column: true, children: [_jsx(VideoGuide, { viewState: this.props.viewState, videoLink: ((_a = this.props.viewState.terria.configParameters.storyVideo) === null || _a === void 0 ? void 0 : _a.videoUrl) ||
