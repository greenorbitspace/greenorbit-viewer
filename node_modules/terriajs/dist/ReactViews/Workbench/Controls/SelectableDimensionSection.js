...
let SelectableDimensionSection = class SelectableDimensionSection extends Component {
    render() {
        ...
        return (_jsx(Box, { displayInlineBlock: true, fullWidth: true, children: selectableDimensions.map((dim, _i) => (_jsx(SelectableDimension, { id: `${item.uniqueId}-${dim.id}`, dim: dim }, `${item.uniqueId}-${dim.id}-fragment`))) }));
    }
};
