...
const ViewingControls = observer((props) => {
    ...
    const removeFromMap = useCallback(() => {
        ...
        (_a = viewState.terria.analytics) === null || _a === void 0 ? void 0 : _a.logEvent(Category.dataSource, DataSourceAction.removeFromWorkbench, getPath(item));
    }, [item, viewState]);
    ...
    const viewingControls = useMemo(() => {
        ...
        return sortBy(uniqBy([...itemViewingControls, ...globalViewingControls], "id"), "name");
    ...
    const renderViewingControlsMenu = () => {
        ...
        return (_jsxs("ul", { children: [viewingControls.map((viewingControl) => (_jsx("li", { children: _jsx(ViewingControlMenuButton, { onClick: () => handleOnClick(viewingControl), title: viewingControl.iconTitle, children: _jsxs(BoxViewingControl, { children: [_jsx(StyledIcon, { ...viewingControl.icon }), _jsx("span", { children: viewingControl.name })] }) }) }, viewingControl.id))), canSplit ? (_jsx("li", { children: _jsx(ViewingControlMenuButton, { onClick: splitItem, title: t("workbench.splitItemTitle"), children: _jsxs(BoxViewingControl, { children: [_jsx(StyledIcon, { glyph: Icon.GLYPHS.compare }), _jsx("span", { children: t("workbench.splitItem") })] }) }) }, "workbench.splitItem")) : null, viewState.useSmallScreenInterface === false &&
                    DiffableMixin.isMixedInto(item) &&
                    !item.isShowingDiff &&
                    item.canDiffImages ? (_jsx("li", { children: _jsx(ViewingControlMenuButton, { onClick: openDiffTool, title: t("workbench.diffImageTitle"), children: _jsxs(BoxViewingControl, { children: [_jsx(StyledIcon, { glyph: Icon.GLYPHS.difference }), _jsx("span", { children: t("workbench.diffImage") })] }) }) }, "workbench.diffImage")) : null, viewState.useSmallScreenInterface === false &&
                    ExportableMixin.isMixedInto(item) &&
                    item.canExportData ? (_jsx("li", { children: _jsx(ViewingControlMenuButton, { onClick: exportDataClicked, title: t("workbench.exportDataTitle"), children: _jsxs(BoxViewingControl, { children: [_jsx(StyledIcon, { glyph: Icon.GLYPHS.upload }), _jsx("span", { children: t("workbench.exportData") })] }) }) }, "workbench.exportData")) : null, viewState.useSmallScreenInterface === false &&
    ...
    return (_jsxs(Box, { children: [_jsxs(Ul, { css: `
        ...
        `, gap: 2, children: [_jsx(WorkbenchButton, { onClick: zoomTo, title: t("workbench.zoomToTitle"), disabled: 
