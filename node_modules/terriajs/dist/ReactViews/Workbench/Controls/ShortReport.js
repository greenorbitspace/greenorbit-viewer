...
let ShortReport = class ShortReport extends Component {
    ...
    render() {
        ...
        return (_jsxs(Box, { fullWidth: true, displayInlineBlock: true, children: [isDefined(item.shortReport) && (_jsx(Text, { textGreyLighter: true, medium: true, children: parseCustomMarkdownToReact(item.shortReport, {
                        catalogItem: item
                    }) })), shortReportSections
                    .filter((r) => r.name)
                    .map((r, i) => (_jsxs(Fragment, { children: [r.content ? (_jsx(Collapsible, { title: r.name, isOpen: r.show, onToggle: (show) => this.clickShortReport(item, r.name, show), children: parseCustomMarkdownToReact(r.content, {
                                catalogItem: item
                            }) })) : (_jsx(Text, { textGreyLighter: true, medium: true, children: parseCustomMarkdownToReact(r.name, {
                                catalogItem: item
