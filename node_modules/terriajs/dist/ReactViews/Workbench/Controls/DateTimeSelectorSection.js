...
let DateTimeSelectorSection = class DateTimeSelectorSection extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (_jsxs(Box, { column: true, paddedVertically: true, children: [_jsx(Text, { medium: true, textLight: true, id: "dateTimeSelectorLabel", children: (_a = item.timeLabel) !== null && _a !== void 0 ? _a : t("dateTime.selectorLabel") }), _jsx(Spacing, { bottom: 1 }), _jsxs(Box, { fullWidth: true, justifySpaceBetween: true, styledHeight: "40px", gap: true, children: [_jsxs(Box, { backgroundColor: this.props.theme.darkLighter, css: `
              border-radius: 2px;
              flex-grow: 1;
            `, children: [_jsx(StyledButton, { disabled: !item.isPreviousDiscreteTimeAvailable, onClick: this.onPreviousButtonClicked, title: t("dateTime.previous"), css: `
              ...
              `, children: _jsx(StyledIcon, { fillColor: this.props.theme.grey, glyph: GLYPHS.previous, styledWidth: "8px" }) }), _jsx(StyledButton, { onClick: this.toggleOpen, title: t("dateTime.selectTime"), id: "current-date-btn", css: `
                flex-grow: 1;
                padding: 0 10px;
              `, children: _jsx(TextSpan, { textLight: true, id: "current-date", children: isDefined(discreteTime)
                                            ? discreteTime
              ...
              `, title: t("dateTime.selectTime"), children: _jsx(DateTimePicker, { currentDate: item.currentDiscreteJulianDate === undefined
                                            ? undefined
                                            : JulianDate.toDate(item.currentDiscreteJulianDate), dates: item.objectifiedDates, onChange: this.changeDateTime, openDirection: "down", isOpen: this.state.isOpen, onClose: this.onClose, dateFormat: format }) })] }), _jsx(TimelineButton, { active: attachedToTimeline, type: "button", onClick: this.onTimelineButtonClicked, title: t("dateTime.useTimeline"), children: _jsx(StyledIcon, { light: true, styledWidth: "20px", glyph: GLYPHS.timeline }) }), _jsx(TimelineButton, { active: item.showInChartPanel, type: "button", onClick: this.onShowOnChartButtonClicked, title: t("dateTime.availableTimeChart"), children: _jsx(StyledIcon, { light: true, styledWidth: "20px", glyph: GLYPHS.lineChart }) })] })] }));
    }
};
