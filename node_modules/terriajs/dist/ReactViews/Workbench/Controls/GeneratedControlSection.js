...
const GeneratedControlSection = ({ item, controls, placement }) => {
    ...
    return (_jsx(Box, { displayInlineBlock: true, fullWidth: true, children: enabledDimensions.map((dim, _i) => (_jsx(SelectableDimensionComponent, { id: `${item.uniqueId}-generated-control-${dim.id}`, dim: dim }, `${item.uniqueId}-generated-control-${dim.id}-fragment`))) }));
};
