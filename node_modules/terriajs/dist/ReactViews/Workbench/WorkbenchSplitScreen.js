    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Box, { fullWidth: true, column: true, css: `
          ...
          `, children: [_jsxs(Box, { fullWidth: true, centered: true, justifySpaceBetween: true, css: `
            ...
            `, children: [_jsx(Box, { children: t("workbench.splitScreenMode") }), _jsx(RawButton, { onClick: () => {
                ...
                display: flex;
                align-items: center;
              `, children: _jsx(StyledIcon, { glyph: GLYPHS.close, light: true, styledWidth: "1em" }) })] }), _jsx(Box, { fullWidth: true, paddedRatio: 3, children: _jsx(TerrainSide, { terria: terria, spaced: false, buttonProps: {
                                css: `border: 0;
                padding: 8px 0;
                border-radius: 3px;
                &:nth-of-type(even) {
