...
class Prompt extends PureComponent {
    ...
    render() {
        var _a, _b;
        return (_jsx(FadeIn, { isVisible: this.props.isVisible, children: _jsxs(Box, { displayInlineBlock: true, rounded: true, position: "absolute", backgroundColor: (_a = this.props.theme) === null || _a === void 0 ? void 0 : _a.colorPrimary, paddedRatio: 3, styledWidth: `${this.props.promptWidth || 200}px`, css: `
