...
let InvokeFunction = class InvokeFunction extends Component {
    ...
    getParams() {
        ...
        // displayed
        return this.props.previewed.functionParameters.map((param, _i) => (_jsx(ParameterEditor, { parameter: param, viewState: this.props.viewState, previewed: this.props.previewed, parameterViewModel: this.parametersViewModel.getParameter(param) }, param.id + this.props.previewed.uniqueId)));
    }
    ...
    render() {
        ...
        const invalidParameters = this.props.previewed.functionParameters.some((param) => this.validateParameter(param) !== true);
        const { t } = this.props;
