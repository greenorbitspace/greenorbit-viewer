 ...
 */
let Description = class Description extends Component {
    ...
    render() {
        ...
        `, children: [catalogItem.isExperiencingIssues && (_jsx(WarningBox, { children: t("preview.mayBeExperiencingIssues") })), catalogItem.description && catalogItem.description.length > 0 && (_jsxs("div", { children: [_jsx("h4", { className: Styles.h4, children: t("description.name") }), parseCustomMarkdownToReact(catalogItem.description, {
                    ...
                    !catalogItem.hideDefaultDescription && (_jsx("p", { children: t("description.dataNotLocal") })), metadataUrls && metadataUrls.length > 0 && (_jsxs(_Fragment, { children: [_jsx("h4", { className: Styles.h4, children: t("description.metadataUrls") }), metadataUrls.map((metadataUrl, _i) => (_jsx(Box, { paddedVertically: true, children: _jsxs("a", { href: metadataUrl.url, target: "_blank", rel: "noopener noreferrer", className: `${Styles.link} description-metadataUrls`, css: `
                    color: ${(p) => p.theme.colorPrimary};
                            ...
                            catalogItem: catalogItem
                                    ...
                                    (catalogItem.type === "esri-mapServer" &&
                                        defined(catalogItem.layers) && (_jsxs("p", { children: [t("description.layerName"), (catalogItem.layers || "").split(",").length > 1
                                            ...
                                            ? "s"
                                            : "", ": ", catalogItem.typeNames] }, "wfs-typeNames"))] })), dataUrls && dataUrls.length > 0 && (_jsxs(_Fragment, { children: [_jsx("h4", { className: Styles.h4, children: t("description.dataUrl") }), dataUrls.map((dataUrl, _i) => {
                                    var _a, _b, _c, _d;
