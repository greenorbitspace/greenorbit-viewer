...
export const HelpPrompt = ({ title, content, dismissLabel, acceptLabel, onDismiss, onAccept, isVisible }) => {
    ...
    return (_jsx(FadeIn, { isVisible: isVisible, onEnter: () => setChildrenVisible(true), transitionProps: {
        ...
        }, nodeRef: fadeRef, children: _jsxs(Box, { ref: fadeRef, fullWidth: true, fullHeight: true, position: "absolute", css: `
          z-index: ${(p) => Number(p.theme.frontComponentZIndex) + 100};
        `, children: [_jsx(TourPrefaceBox, { onClick: onDismiss, role: "presentation", "aria-hidden": "true", pseudoBg: true }), _jsx(SlideUpFadeIn, { isVisible: childrenVisible, nodeRef: slideInRef, children: _jsxs(TourExplanationBox, { ref: slideInRef, longer: true, paddedRatio: 4, column: true, style: {
                            right: 25,
                            bottom: 45
