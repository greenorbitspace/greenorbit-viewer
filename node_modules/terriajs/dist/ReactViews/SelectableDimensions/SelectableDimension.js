...
const SelectableDimension = ({ id, dim }) => {
    return (_jsxs(Box, { displayInlineBlock: true, fullWidth: true, styledMargin: "0 0 5px 0", children: [dim.name && dim.type !== "group" ? (_jsxs(_Fragment, { children: [_jsx("label", { htmlFor: id, children: _jsxs(Text, { textGreyLighter: true, medium: true, as: "span", children: [parseCustomMarkdownToReactWithOptions(dim.name, {
                                    inline: true
