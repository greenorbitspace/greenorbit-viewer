...
:root {
  ...
  --theme-transparent-dark: ${(p) => {
    var _a, _b;
    return (_b = (_a = Color.fromCssColorString(p.theme.dark)) === null || _a === void 0 ? void 0 : _a.withAlpha(parseFloat(p.theme.darkAlpha)).toCssHexString()) !== null && _b !== void 0 ? _b : p.theme.dark;
}}
}
`;
