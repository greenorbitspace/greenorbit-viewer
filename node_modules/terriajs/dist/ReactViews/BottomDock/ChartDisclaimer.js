...
const ChartDisclaimer = ({ terria }) => {
    ...
    return (_jsxs(Box, { backgroundColor: "#9a4b4b", column: true, paddedHorizontally: 2, css: `
      ...
      `, children: [_jsx(Spacing, { bottom: 2 }), uniqueChartDisclaimers.map((chartDisclaimer) => (_jsxs(Fragment, { children: [_jsx(Text, { textLight: true, children: parseCustomHtmlToReact(chartDisclaimer) }), _jsx(Spacing, { bottom: 2 })] }, chartDisclaimer)))] }));
};
