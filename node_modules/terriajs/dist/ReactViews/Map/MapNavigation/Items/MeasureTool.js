...
export class MeasureTool extends MapNavigationItemController {
    constructor(props) {
        ...
        Object.defineProperty(this, "totalDistanceMetres", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "totalAreaMetresSquared", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "userDrawing", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    updateArea(pointEntities) {
        ...
        const polygons = PolygonGeometryLibrary.polygonsFromHierarchy(new PolygonHierarchy(positions), false, tangentPlane.projectPointsOntoPlane.bind(tangentPlane), !perPositionHeight, Ellipsoid.WGS84);
        const geom = PolygonGeometryLibrary.createGeometryFromPositions(Ellipsoid.WGS84, polygons.polygons[0], undefined, CesiumMath.RADIANS_PER_DEGREE, perPositionHeight, VertexFormat.POSITION_ONLY, ArcType.GEODESIC);
...
Object.defineProperty(MeasureTool, "id", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: "measure-tool"
});
Object.defineProperty(MeasureTool, "displayName", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: "MeasureTool"
