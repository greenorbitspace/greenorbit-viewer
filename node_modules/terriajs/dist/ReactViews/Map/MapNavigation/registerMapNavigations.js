...
import { AR_TOOL_ID, AugmentedVirtualityController, AugmentedVirtualityHoverController, AugmentedVirtualityRealign, AugmentedVirtualityRealignController, Compass, COMPASS_TOOL_ID, MeasureTool, MyLocation, ToggleSplitterController, ZoomControl, ZOOM_CONTROL_ID } from "./Items";
export const registerMapNavigations = (viewState) => {
    ...
    mapNavigationModel.addItem({
        ...
        order: 1,
        screenSize: "medium",
        render: _jsx(Compass, { terria: terria, viewState: viewState })
    });
    ...
    mapNavigationModel.addItem({
        ...
        order: 2,
        screenSize: "medium",
        render: _jsx(ZoomControl, { terria: terria })
    });
    ...
    mapNavigationModel.addItem({
        ...
        render: (_jsx(AugmentedVirtualityRealign, { arRealignController: arRealignController })),
        order: 1,
        noExpand: true
    });
