...
export const Splitter = observer(({ thumbSize = 48, padding = 0 }) => {
    ...
    return (_jsxs("div", { children: [_jsx("div", { style: { position: "absolute", width: "100%", height: "100%" }, children: _jsx("div", { style: {
                    ...
                    alignItems: "center"
                }, onClick: (e) => e.preventDefault(), onMouseDown: startDrag, onTouchStart: startDrag, title: t("splitterTool.title"), children: _jsx(StyledIcon, { glyph: GLYPHS.splitter, fillColor: "white", styledWidth: "20px", styledHeight: "20px" }) })] }));
});
