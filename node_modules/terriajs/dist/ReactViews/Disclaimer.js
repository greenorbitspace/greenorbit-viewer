...
`;
let Disclaimer = class Disclaimer extends Component {
    ...
    render() {
        ...
        return disclaimer ? (_jsx(FadeIn, { isVisible: this.props.viewState.disclaimerVisible, children: _jsxs(TopElementBox, { position: "absolute", fullWidth: true, fullHeight: true, centered: true, children: [_jsx(BackgroundImage
              ...
              max-height: 100%;
              overflow: auto;
            `, children: [_jsx(Text, { styledFontSize: "18px", styledLineHeight: "24px", bold: true, textLight: true, children: disclaimerTitle }), _jsx(Spacing, { bottom: 4 }), _jsx(Text, { styledLineHeight: "18px", textLight: true, css: `
