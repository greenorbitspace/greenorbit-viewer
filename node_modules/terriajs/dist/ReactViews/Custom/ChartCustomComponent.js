    ...
    processChart(context, node, children, _index) {
            ...
            const sourceItems = (attrs.downloads || attrs.sources || [""]).map((source, i) => {
                ...
                return Promise.resolve(itemOrPromise).then(action((item) => {
                    ...
                    if (item) {
                        ...
                        if (body) {
                            (_a = this.setTraitsFromBody) === null || _a === void 0 ? void 0 : _a.call(this, item, body);
                        }
                        if (featurePosition &&
        ...
        if (chartItem) {
            runInAction(() => {
                ...
                if (body) {
                    (_a = this.setTraitsFromBody) === null || _a === void 0 ? void 0 : _a.call(this, chartItem, body);
                }
            });
            chartElements.push(createElement(Chart, {
                ...
                yColumn: (_c = attrs.yColumns) === null || _c === void 0 ? void 0 : _c[0],
                height: 110
