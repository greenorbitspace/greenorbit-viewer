...
let Legends = class Legends extends PureComponent {
    render() {
...
class Legend extends PureComponent {
    render() {
        ...
        return (_jsxs(LegendWrapper, { title: label.text, "aria-label": label.text, children: [_jsx("svg", { width: `${squareSize}px`, height: `${squareSize}px`, style: { flexShrink: 0 }, children: _jsx(Glyph, { top: 10, left: 10, fill: label.value, size: 100 }) }), _jsx(LegendText, { children: label.text })] }));
    }
}
