...
import { Component, Children, isValidElement, cloneElement, useEffect, useRef } from "react";
...
let FeedbackForm = class FeedbackForm extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (_jsxs(FormWrapper, { children: [_jsxs(Box, { backgroundColor: theme.darkLighter, paddedRatio: 2, children: [_jsx(Text, { textLight: true, textAlignCenter: true, semiBold: true, as: "h4", fullWidth: true, css: `
            ...
            `, children: t("feedback.title") }), _jsx(RawButton, { onClick: this.onDismiss, title: t("feedback.close"), children: _jsx(StyledIcon, { styledWidth: "15px", light: true, glyph: GLYPHS.close }) })] }), _jsxs(Form, { paddedRatio: 2, onSubmit: this.onSubmit.bind(this), column: true, children: [_jsx(Text, { textDarker: true, children: preamble }), _jsx(StyledLabel, { viewState: viewState, textProps: {
                                ...
                                }) }) }), _jsx(Spacing, { bottom: 2 }), postamble ? _jsx(Text, { textDarker: true, children: postamble }) : null, _jsxs(Box, { right: true, children: [_jsx(Button, { type: "button", denyButton: true, shortMinHeight: true, styledMinWidth: "80px", onClick: this.onDismiss, children: t("feedback.cancel") }), _jsx(Spacing, { right: 1 }), _jsx(Button, { type: "submit", primary: true, shortMinHeight: true, styledMinWidth: "80px", disabled: this.state.comment.length <
