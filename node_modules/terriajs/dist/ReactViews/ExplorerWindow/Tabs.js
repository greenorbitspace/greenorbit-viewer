...
let Tabs = class Tabs extends Component {
    ...
    getTabs() {
        ...
        if (this.props.terria.configParameters.tabbedCatalog) {
            return [].concat(this.props.terria.catalog.group.memberModels
                ...
                panel: (_jsx(DataCatalogTab, { items: member.memberModels || [member], searchPlaceholder: t("addData.searchPlaceholderWhole") }))
            })), [myDataTab]);
        }
        else {
            return [
                {
                    ...
                    title: "data-catalog",
                    category: "data-catalog",
                    panel: (_jsx(DataCatalogTab, { items: this.props.terria.catalog.group.memberModels, searchPlaceholder: t("addData.searchPlaceholder") }))
                },
                myDataTab
            ];
        }
