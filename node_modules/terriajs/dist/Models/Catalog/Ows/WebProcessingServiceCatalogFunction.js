...
class WpsLoadableStratum extends LoadableStratum(WebProcessingServiceCatalogFunctionTraits) {
    ...
    get storeSupported() {
        var _a;
        const value = (_a = this.processDescription.storeSupported) === null || _a === void 0 ? void 0 : _a.toLowerCase();
        return value === "true" ? true : value === "false" ? false : undefined;
    }
    get statusSupported() {
        var _a;
        const value = (_a = this.processDescription.statusSupported) === null || _a === void 0 ? void 0 : _a.toLowerCase();
        return value === "true" ? true : value === "false" ? false : undefined;
    }
}
