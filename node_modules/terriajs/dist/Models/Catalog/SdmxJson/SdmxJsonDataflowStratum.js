...
export class SdmxJsonDataflowStratum extends LoadableStratum(SdmxCatalogItemTraits) {
    ...
    get dimensions() {
        ...
        return (this.sdmxDimensions
            ...
            const options = isDefined(overrideOptions) && overrideOptions.length > 0
    ...
    get featureInfoTemplate() {
        ...
        if (this.catalogItem.discreteTimes &&
            ...
            template += `</table>{{#terria.timeSeries.data}}<chart title="${chartName}" x-column="{{terria.timeSeries.xName}}" y-column="${(_k = this.primaryMeasureColumn) === null || _k === void 0 ? void 0 : _k.title}" >{{terria.timeSeries.data}}</chart>{{/terria.timeSeries.data}}`;
        }
