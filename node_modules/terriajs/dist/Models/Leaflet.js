...
export default class Leaflet extends GlobeOrMap {
    ...
    async _featurePicked(entity, event) {
        ...
        if (FeatureInfoUrlTemplateMixin.isMixedInto(catalogItem) &&
            ...
            const result = await catalogItem.getFeaturesFromPickResult.bind(catalogItem)(undefined, entity, (((_a = this._pickedFeatures) === null || _a === void 0 ? void 0 : _a.features.length) || 0) < catalogItem.maxRequests);
