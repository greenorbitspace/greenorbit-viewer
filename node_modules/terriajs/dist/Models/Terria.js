...
export default class Terria {
    ...
    constructor(options = {}) {
        ...
        Object.defineProperty(this, "appBaseHref", {
            ...
            configurable: true,
            writable: true,
            value: ensureSuffix(typeof document !== "undefined" ? document.baseURI : "/", "/")
        });
        ...
        const cesiumBaseUrlRelative = (_a = options.cesiumBaseUrl) !== null && _a !== void 0 ? _a : `${this.baseUrl}build/Cesium/build/`;
    ...
    async start(options) {
        ...
        if (options.errorService) {
            try {
                ...
                console.error(`Failed to initialize error service: ${(_c = this.configParameters.errorService) === null || _c === void 0 ? void 0 : _c.provider}`, e);
            }
        }
        (_d = this.analytics) === null || _d === void 0 ? void 0 : _d.start(this.configParameters);
        (_f = this.analytics) === null || _f === void 0 ? void 0 : _f.logEvent(Category.launch, LaunchAction.url, launchUrlForAnalytics);
