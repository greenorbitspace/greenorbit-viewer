    ...
    async _highlightFeature(feature) {
        ...
        if (isDefined(feature)) {
            ...
            if (isDefined(feature._cesium3DTileFeature)) {
                ...
                cesiumPolygon.polygon.outlineColor = new ConstantProperty((_a = Color.fromCssColorString(this.terria.baseMapContrastColor)) !== null && _a !== void 0 ? _a : Color.GRAY);
                cesiumPolygon.polygon.material = new ColorMaterialProperty(new ConstantProperty(((_b = Color.fromCssColorString(this.terria.baseMapContrastColor)) !== null && _b !== void 0 ? _b : Color.LIGHTGRAY).withAlpha(0.75)));
                this._removeHighlightCallback = function () {
                ...
                cesiumPolyline.polyline.material =
                    (_c = Color.fromCssColorString(this.terria.baseMapContrastColor)) !== null && _c !== void 0 ? _c : Color.LIGHTGRAY;
            ...
            if (!hasGeometry) {
                ...
                if (((_d = feature.imageryLayer) === null || _d === void 0 ? void 0 : _d.imageryProvider) instanceof
