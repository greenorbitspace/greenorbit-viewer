...
__decorate([
    primitiveArrayTrait({
        name: "Dash Pattern",
        description: "An Array of numbers that specify distances to alternately draw a line and a gap (in pixels). If undefined, then line is solid. Note: only supported by line features (through GeoJSON Mixin)",
        type: "number"
    })
], OutlineSymbolTraits.prototype, "dash", void 0);
