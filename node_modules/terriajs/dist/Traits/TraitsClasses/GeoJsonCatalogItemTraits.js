...
let GeoJsonCatalogItemTraits = class GeoJsonCatalogItemTraits extends mixTraits(GeoJsonTraits, ApiRequestTraits, CesiumIonTraits) {
    constructor() {
        super(...arguments);
...
GeoJsonCatalogItemTraits = __decorate([
    traitClass({
...
export default GeoJsonCatalogItemTraits;
