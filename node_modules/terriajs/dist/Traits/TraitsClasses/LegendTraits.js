...
export class LegendItemTraits extends ModelTraits {
    constructor() {
        ...
        Object.defineProperty(this, "outlineStyle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
__decorate([
    primitiveTrait({
        name: "Outline Style",
        description: "The style of outline using CSS outline-style values. Eg 'dotted', 'dashed', 'solid', 'double', 'groove', 'ridge', 'inset', 'outset'",
        type: "string"
    })
], LegendItemTraits.prototype, "outlineStyle", void 0);
__decorate([
    primitiveArrayTrait({
