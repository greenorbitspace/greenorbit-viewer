...
let CzmlCatalogItemTraits = class CzmlCatalogItemTraits extends mixTraits(AutoRefreshingTraits, TimeVaryingTraits, UrlTraits, CatalogMemberTraits, LegendOwnerTraits, MappableTraits, CesiumIonTraits) {
    constructor() {
        super(...arguments);
...
CzmlCatalogItemTraits = __decorate([
    traitClass({
...
export default CzmlCatalogItemTraits;
