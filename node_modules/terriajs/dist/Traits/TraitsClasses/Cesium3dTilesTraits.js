...
export default class Cesium3DTilesTraits extends mixTraits(HighlightColorTraits, PlaceEditorTraits, TransformationTraits, FeaturePickingTraits, MappableTraits, UrlTraits, CatalogMemberTraits, ShadowTraits, OpacityTraits, LegendOwnerTraits, ShadowTraits, ClippingPlanesTraits, SplitterTraits, CesiumIonTraits) {
    constructor() {
        super(...arguments);
        ...
        Object.defineProperty(this, "lightColor", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
__decorate([
    primitiveArrayTrait({
        name: "lightColor",
        type: "number",
        description: "The light color when shading models. When undefined the scene's light color is used instead. eg: [255, 255, 255]."
    })
], Cesium3DTilesTraits.prototype, "lightColor", void 0);
