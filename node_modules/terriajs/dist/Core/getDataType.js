 ...
 */
export const customRemoteDataTypes = observable(new Map());
/**
 * Custom local data types. Add by calling addOrReplaceLocalFileUploadType().
 */
export const customLocalDataTypes = observable(new Map());
export default function getDataTypes() {
    const uniqueRemoteDataTypes = new Map([
        ...builtinRemoteDataTypes.map((dtype) => [dtype.value, dtype]),
        ...customRemoteDataTypes.entries()
    ]);
    const uniqueLocalDataTypes = new Map([
        ...builtinLocalDataTypes.map((dtype) => [dtype.value, dtype]),
 ...
 */
export const addOrReplaceRemoteFileUploadType = action((key, newRemoteDataType) => {
 ...
 */
export const addOrReplaceLocalFileUploadType = action((key, newLocalDataType) => {
